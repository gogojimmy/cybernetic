...
role :web, "cybernetic.com"                          # Your HTTP server, Apache/etc
role :app, "cybernetic.com"                         # This may be the same as your `Web` server
role :db,  "cybernetic.com"   , :primary => true # This is where Rails migrations will run
